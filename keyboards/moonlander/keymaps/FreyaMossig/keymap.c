...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_DEL,  KC_Q,          KC_W,    KC_E,    KC_R,    KC_T,    TG(SYMB),          TG(SYMB), KC_Z,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
        ...
        KC_GRV,  WEBUSB_PAIR,   KC_SPC,  KC_LEFT, KC_RGHT,          KC_APP,            KC_ESC,            KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(SYMB),
