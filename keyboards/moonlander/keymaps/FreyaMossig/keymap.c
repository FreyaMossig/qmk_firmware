...
enum layers {
    ...
    SYMB,  // symbols
    MDIA,  // media keys
    LEAG,  // League of Legends layer
};

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX,          TG(LEAG), KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    ...
    [LEAG] = LAYOUT_moonlander(
        KC_P,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             _______, _______, _______, _______, _______, _______, _______,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    _______,           _______, _______, _______, _______, _______, _______, _______,
        _______, KC_A,    _______, KC_D,    KC_F,    KC_G,    KC_H,              _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, KC_C,    _______, KC_B,                                _______, _______, _______, _______, _______, _______, 
        KC_LCTL, _______, _______, KC_P,    KC_LALT,          KC_ESC,            _______,          _______, _______, _______, _______, _______,
                                            KC_SPC,  KC_2,    KC_MUTE,           _______, _______, _______
    ),
};
